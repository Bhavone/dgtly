        ...
        <div className="subSolution">
            <div className="text">
                <div className="upperText">
                    <p>Every second a user hesitates, you lose revenue. Discover how to keep them engaged.</p>
                    <p className="para1">Join <span id="name1">Anna Potanina</span>(ex-Google UX Lead, Founder of <span id="digital">Call to Action Digital</span>) and <span id="name2">Bhavna Taneja</span>(ex-Google UX, Founder of <span id="dgtly">DGTLY</span>) as they share high-impact strategies used by top-performing apps and websites.</p>
            ...
            <div className="timer">
                ...
                <div className="calendar">
                    ...
                    <div className="register"> 
                        <Reserve/>
                        <p id="content">Can't attend? Register to get the recording. Let's improve your apps and websites for users!</p>
